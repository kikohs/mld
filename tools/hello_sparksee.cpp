...
int main(int argc, char *argv[])
{
    ...
    sparkseeManager.createDatabase(mld::kRESOURCES_DIR + L"HelloSparksee.sparksee", L"HelloSparksee");
    ...
    // Add a node type for the movies, with a unique identifier and two insparkseeed attributes
    ...
    // Add a node type for the people, with a unique identifier and an insparkseeed attribute
