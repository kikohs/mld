...
namespace json_spirit
{
    ...
    void         write( const mValue& value, std::ostream&  os, Output_options options = none, unsigned int precision_of_doubles = 0 );
    std::string  write( const mValue& value, Output_options options = none, unsigned int precision_of_doubles = 0 );
#endif

#if defined( JSON_SPIRIT_WVALUE_ENABLED ) && !defined( BOOST_NO_STD_WSTRING )
    void         write( const wValue&  value, std::wostream& os, Output_options options = none, unsigned int precision_of_doubles = 0 );
    std::wstring write( const wValue&  value, Output_options options = none, unsigned int precision_of_doubles = 0 );
#endif

#if defined( JSON_SPIRIT_WMVALUE_ENABLED ) && !defined( BOOST_NO_STD_WSTRING )
    void         write( const wmValue& value, std::wostream& os, Output_options options = none, unsigned int precision_of_doubles = 0 );
    std::wstring write( const wmValue& value, Output_options options = none, unsigned int precision_of_doubles = 0 );
#endif
