...
namespace json_spirit
{
    ...
    public:
        ...
        Generator( const Value_type& value, Ostream_type& os, Output_options options, unsigned int precision_of_doubles )
        :   os_( os )
    ...
    //
    template< class Value_type, class Ostream_type >
    void write_stream( const Value_type& value, Ostream_type& os, Output_options options = none, unsigned int precision_of_doubles = 0 )
    {
        os << std::dec;
    ...
    typename Value_type::String_type write_string( const Value_type& value, Output_options options = none, unsigned int precision_of_doubles = 0 )
    {
